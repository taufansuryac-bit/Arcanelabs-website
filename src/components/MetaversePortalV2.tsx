...
export function MetaversePortalV2() {
  ...
  const portalOpacity = useTransform(scrollYProgress, [0.9, 0.99, 1], [1, 0.55, 0]);

  return (
    <section
      ref={sectionRef}
      className="relative z-10 -mb-[24vh] h-[200vh] border-t border-border md:-mb-[32vh] md:h-[430vh]"
    >
      <motion.div
