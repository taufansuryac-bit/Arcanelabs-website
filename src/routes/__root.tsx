...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo+Black&family=JetBrains+Mono:wght@300;400;500&display=swap",
      },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var m=localStorage.getItem('al-theme')||'dark';document.documentElement.classList.toggle('dark',m==='dark')}catch(e){}",
          }}
        />
      </head>
      <body>
